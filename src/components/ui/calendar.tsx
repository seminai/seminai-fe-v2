...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "p-3 bg-white rounded-2xl shadow-lg border border-border/40",
        className
      )}
      classNames={{
        ...
        cell: cn(
          "relative p-0 text-center text-sm focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-agri-green-50 [&:has([aria-selected].day-range-end)]:rounded-r-md",
          props.mode === "range"
        ...
        day_range_start:
          "day-range-start aria-selected:bg-agri-green-500 aria-selected:text-white",
        day_range_end:
