...
export interface Question {
  ...
  readonly type: "single_select" | "multi_select" | "text";
...
export interface QuestionnaireCardProps {
  ...
  readonly onSubmit: (answers: Record<string, string | string[]>) => void;
  readonly disabled?: boolean;
}

/**
 * Renders a structured questionnaire with single/multi-select and text inputs.
 * Used by any agent that needs to gather structured information from the user.
 */
